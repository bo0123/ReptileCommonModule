...
class DouyuSpider:
    def __init__(self):
        ...
        abspath = os.path.abspath(
            r"D:\PycharmProjects\ReptileCommonModule\06day_slenium\chromedriver_win32_chrome80.0.3987.16\chromedriver.exe")
        # driver = webdriver.Chrome(executable_path=abspath)
        # self.driver = webdriver.Chrome()
        # self.driver = webdriver.Chrome(executable_path=abspath, chrome_options=chrome_options, )
        self.driver = webdriver.Chrome(executable_path=abspath)
