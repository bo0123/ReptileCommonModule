...
class TiebaSpider:
    def __init__(self,tieba_name):
        ...
        self.start_url = "http://tieba_urllib_r.baidu.com/mo/q----,sz@320_240-1-3---2/m?kw="+tieba_name+"&pn=0"
        self.part_url = "http://tieba_urllib_r.baidu.com/mo/q----,sz@320_240-1-3---2/"
